...
def BigGan(sn=False):
    ...
    net = Block(net, z_c, ch*8, ch*8, 
        name='block_5') 
    net = Block(net, z_c, ch*8, ch*8, up=True,
        name='block_6') 
    net = Block(net, z_c, ch*8, ch*8, 
        name='block_7') 
    net = Block(net, z_c, ch*8, ch*4, up=True,
        name='block_8') 
    net = O.layers.SelfAttention(filters=ch*4, reduction=8, sn=sn, 
        name='attention')(net)   
    ...
    net = Block(net, z_c, ch*2, ch*1, up=True, 
        name='block_12') 
    net = Block(net, z_c, ch*1, ch*1,
        name='block_13') 
    net = Block(net, z_c, ch*1, ch*1, up=True, 
        name='block_14') 
